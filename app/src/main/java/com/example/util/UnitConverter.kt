...
enum class LengthUnit(val label: String, val symbol: String, val ratioToBase: Double) {
    METERS("Meters", "m", 1.0),
...
enum class MassUnit(val label: String, val symbol: String, val ratioToBase: Double) {
