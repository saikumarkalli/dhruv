...
> `platform/DECISIONS.md` ADR-0014 → `apps/finance/docs/superpowers/specs/2026-07-03-tracker-roadmap-overview.md`
> → `2026-07-03-p1-networth-tracker-design.md` (build target) → `platform/DESIGN-SYSTEM.md`
...
- [ ] A1. Unstage unrelated currency files (separate work, do not mix):
      `apps/finance/docs/superpowers/plans/2026-07-03-currency-metals-notification.md`,
      `apps/finance/docs/superpowers/specs/2026-07-03-currency-realtime-rates-daily-notification-design.md`
...
- [ ] H18. **T10**: `apps/finance/FEATURES.md` networth section; `apps/finance/CLAUDE.md` (module
      list, new nav shape, `.env` config note); `apps/finance/PRODUCTION_READINESS.md` tracker rows;
