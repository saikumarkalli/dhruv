...
| 3 — Money tab | [`apps/finance/specs/002-money-tab/`](../../../specs/002-money-tab/) | **shipped 2026-09-05** — all 6 user stories (D1–D9) built and merged, 118 tasks (T001–T118, T072–T083 Polish/QA/Sec/coverage closed 2026-09-05 — 2 Sec tasks and 3 device-only tasks close deferred, no live Supabase creds or physical device in this implementation session), `regressionCheck` green, merged coverage 17.40% (floor raised 0.14 → 0.17), `checkTrackerMoneyPrecision` green, catalog §4 MNY module fully closed (18 ✅ / 2 🔴 deferred, §14 Recount 2026-09-05). **Post-ship review (2026-09-06) found 4 P0 usability defects and 6 requirements delivered in name only** (no edit surface for a transaction/account/recurring rule, no saved-view UI, no date/receipt entry, back-gesture bypassing unsaved-changes confirmation) — tracked and being closed in [008-money-tab-ux-remediation](../../../specs/008-money-tab-ux-remediation/), not re-opened here |
