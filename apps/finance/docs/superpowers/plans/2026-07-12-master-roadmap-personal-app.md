...
**Production-readiness (verified by audit C, tracked in `apps/finance/PRODUCTION_READINESS.md`):**
...
> `apps/finance/docs/superpowers/specs/` (localization N18 deliberately excluded):
...
> notifications, widget, PDF, legacy screens): `platform/DESIGN-SYSTEM.md`.
...
Source: `apps/finance/PRODUCTION_READINESS.md` phases 0–4 (already planned there; sequenced first here).
