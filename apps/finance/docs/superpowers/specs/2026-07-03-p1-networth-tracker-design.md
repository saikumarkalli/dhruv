...
> Design system: `platform/DESIGN-SYSTEM.md`. Playbook: `2026-07-04-tracker-engineering-playbook.md`.
...
`platform/DESIGN-SYSTEM.md` (binding). Money display: `formatPaiseCompact` on cards,
