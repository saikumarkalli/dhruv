...
class HistoryRepositoryTest {
    ...
    @Test
    fun pruneRemovesOnlyItemsOlderThanRetentionWindow() =
        runBlocking {
    ...
    @Test
    fun insertThenMoveToRecycleBinSoftDeletes() =
        runBlocking {
    ...
    @Test
    fun restoreReactivatesABinnedRow() =
        runBlocking {
    ...
    @Test
    fun emptyRecycleBinClearsBinnedRowsOnly() =
        runBlocking {
