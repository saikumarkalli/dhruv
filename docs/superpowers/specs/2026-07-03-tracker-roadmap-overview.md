...
| Doc | Purpose |
|---|---|
| `2026-07-03-tracker-design-system.md` | UI/UX source of truth: `:libs:core` component inventory, bento specs, tokens, states, a11y checklist. **Micro-frontend rule**: features own screens/flows only; all reusable visuals live in `:libs:core`; zero feature-local styling — one theme, entire app |
